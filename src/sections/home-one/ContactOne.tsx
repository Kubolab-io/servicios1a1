...
import contImg5 from "../../../public/assets/images/resources/contact-one-small-img-2.webp";
...
const CONTACT_INFO: ContactInfo[] = [
    {
        ...
        icon: "icon-envelope",
        label: "Enviar Email",
        title: "info@serviciosunoa.com",
        link: "mailto:info@serviciosunoa.com",
        linkType: "email",
    },
    {
        id: "phone",
...
const SERVICE_OPTIONS: ServiceOption[] = [
    { value: "0", label: "Tipo de Servicio*" },
    { value: "1", label: "Limpieza de Aulas" },
    { value: "2", label: "Sanitización de Baños" },
    { value: "3", label: "Limpieza de Áreas Comunes" },
    { value: "4", label: "Mantenimiento de Áreas Verdes" },
    { value: "5", label: "Desinfección Especializada" },
    { value: "6", label: "Servicio Integral" },
];
