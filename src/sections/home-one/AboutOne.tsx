...
const AboutOne: React.FC = () => {
    ...
    return (
        <>
            <section id="about" className="about-one">
                                ...
                                <div className="about-one__points-box">
                                    <ul className="about-one__points-list list-unstyled">
                                        <li>
                                            ...
                                            <p>Protocolos de limpieza especializados</p>
                                        </li>
                                        <li>
                                            <div className="icon">
                                                <span className="icon-star-1"></span>
                                            </div>
                                            <p>Productos eco-amigables y seguros</p>
                                        </li>
                                        <li>
                                            <div className="icon">
                                                <span className="icon-star-1"></span>
                                            </div>
                                            <p>Personal capacitado y certificado</p>
                                        </li>
                                    </ul>
                                    <ul className="about-one__points-list list-unstyled">
                                        <li>
                                            ...
                                            <p>Horarios flexibles y adaptables</p>
                                        </li>
                                        <li>
                                            <div className="icon">
                                                <span className="icon-star-1"></span>
                                            </div>
                                            <p>Cumplimiento de normas sanitarias</p>
                                        </li>
                                        <li>
                                            <div className="icon">
                                                <span className="icon-star-1"></span>
